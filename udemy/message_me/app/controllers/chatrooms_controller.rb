class ChatroomsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @chatroom.update(chatroom_params)
        format.html { redirect_to @chatroom, notice: "Chatroom was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to chatrooms_path, notice: "Chatroom was successfully destroyed.", status: :see_other }
